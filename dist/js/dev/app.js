...
let coachesSwiper;
let gallerySwiper;
let footergallerySwiper;
let reviewsSwiper;
let blogSwiper;
let contentBlogSwiper;
function initSliders() {
  const aboutSlider = document.querySelector(".about__slider");
  if (aboutSlider) {
    if (window.innerWidth <= 480 && !aboutSwiper) {
    ...
    } else if (window.innerWidth > 480 && aboutSwiper) {
  ...
  if (factsSlider) {
    if (window.innerWidth <= 991.98 && !factsSwiper) {
      factsSwiper = new Swiper(".facts__slider", {
        modules: [Navigation, Pagination],
        observer: true,
        observeParents: true,
        slidesPerView: 1.2,
        ...
        speed: 800,
        pagination: {
          el: ".facts__slider .dotts",
          // 👈 уникальный селектор
          clickable: true
        },
        navigation: {
          prevEl: ".facts__arrow-left",
          nextEl: ".facts__arrow-right"
        },
        breakpoints: {
          0: {
            slidesPerView: 1.2,
    ...
    } else if (window.innerWidth > 991.98 && factsSwiper) {
      factsSwiper.destroy(true, true);
      factsSwiper = null;
    }
  }
  const advantagesSlider = document.querySelector(".advantages__slider");
  if (advantagesSlider) {
    if (window.innerWidth <= 991.98 && !advantagesSwiper) {
    ...
    } else if (window.innerWidth > 991.98 && advantagesSwiper) {
      advantagesSwiper.destroy(true, true);
      advantagesSwiper = null;
    }
  }
  const kidsSlider = document.querySelector(".kids__slider");
  if (kidsSlider) {
    if (window.innerWidth <= 991.98 && !kidsSwiper) {
      kidsSwiper = new Swiper(".kids__slider", {
        modules: [Navigation, Pagination],
        observer: true,
        observeParents: true,
        slidesPerView: 1.2,
        ...
        speed: 800,
        pagination: {
          el: ".kids__slider .dotts",
          // 👈 уникальный селектор
          clickable: true
        },
        navigation: {
          prevEl: ".kids__arrow-left",
          nextEl: ".kids__arrow-right"
        },
        breakpoints: {
          0: {
            slidesPerView: 1.2,
    ...
    } else if (window.innerWidth > 991.98 && kidsSwiper) {
      kidsSwiper.destroy(true, true);
      kidsSwiper = null;
    }
  }
  const trainingSlider = document.querySelector(".training__slider");
  if (trainingSlider) {
    if (window.innerWidth <= 991.98 && !trainingSwiper) {
      trainingSwiper = new Swiper(".training__slider", {
        modules: [Navigation, Pagination],
        observer: true,
        observeParents: true,
        slidesPerView: 1.2,
        ...
        speed: 800,
        pagination: {
          el: ".training__slider .dotts",
          // 👈 уникальный селектор
          clickable: true
        },
        navigation: {
          prevEl: ".training__arrow-left",
          nextEl: ".training__arrow-right"
        },
        breakpoints: {
          0: {
            slidesPerView: 1.2,
    ...
    } else if (window.innerWidth > 991.98 && trainingSwiper) {
  ...
  if (coachesSlider) {
    if (window.innerWidth <= 991.98 && !coachesSwiper) {
      coachesSwiper = new Swiper(".coaches__slider", {
        modules: [Navigation, Pagination],
        observer: true,
        observeParents: true,
        slidesPerView: 1.2,
        ...
        speed: 800,
        pagination: {
          el: ".coaches__slider .dotts",
          // 👈 уникальный селектор
          clickable: true
        },
        navigation: {
          prevEl: ".coaches__arrow-left",
          nextEl: ".coaches__arrow-right"
        },
        breakpoints: {
          0: {
            slidesPerView: 1.1,
    ...
    } else if (window.innerWidth > 991.98 && coachesSwiper) {
      coachesSwiper.destroy(true, true);
      coachesSwiper = null;
    }
  }
  const gallerySlider = document.querySelector(".gallery__slider");
  if (gallerySlider && !gallerySwiper) {
  ...
  const footergallerySlider = document.querySelector(".footer-gallery__slider");
  if (footergallerySlider && !footergallerySwiper) {
    footergallerySwiper = new Swiper(".footer-gallery__slider", {
      modules: [Navigation, Pagination],
      observer: true,
      observeParents: true,
      slidesPerView: 1,
      ...
      speed: 800,
      pagination: {
        el: ".footer-gallery__slider .dotts",
        clickable: true
      },
      navigation: {
        prevEl: ".footer-gallery__arrow-left",
        nextEl: ".footer-gallery__arrow-right"
      },
      breakpoints: {
        0: {
          slidesPerView: 1.2,
  ...
  if (reviewsSlider) {
    if (window.innerWidth <= 991.98 && !reviewsSwiper) {
    ...
    } else if (window.innerWidth > 991.98 && reviewsSwiper) {
      reviewsSwiper.destroy(true, true);
      reviewsSwiper = null;
    }
  }
  const blogSlider = document.querySelector(".blog__slider");
  if (blogSlider && !blogSwiper) {
  ...
  const contentBlogSlider = document.querySelector(".content-blog__slider");
  if (contentBlogSlider) {
    if (window.innerWidth <= 480 && !contentBlogSwiper) {
      contentBlogSwiper = new Swiper(".content-blog__slider", {
        modules: [Navigation, Pagination],
        observer: true,
        observeParents: true,
        slidesPerView: 1.2,
        ...
        speed: 800,
        pagination: {
          el: ".content-blog__slider .dotts",
          // 👈 уникальный селектор
          clickable: true
        },
        navigation: {
          prevEl: ".content-blog__arrow-left",
          nextEl: ".content-blog__arrow-right"
        }
      });
    } else if (window.innerWidth > 480 && contentBlogSwiper) {
      contentBlogSwiper.destroy(true, true);
      contentBlogSwiper = null;
    }
  }
}
...
class Popup {
  ...
  close(selectorValue) {
    ...
    if (this.previousOpen.element) {
      if (document.activeElement && this.previousOpen.element.contains(document.activeElement)) {
...
const arrow = document.querySelector(".hero__arrow, .hero-blog__arrow");
const lastSection = document.querySelector(".blog, .content-blog");
const footer = document.querySelector("footer");
window.addEventListener("scroll", () => {
  if (!arrow || !lastSection || !footer) return;
  arrow.offsetHeight;
  const footerTop = footer.getBoundingClientRect().top;
  lastSection.getBoundingClientRect().bottom;
  const windowHeight = window.innerHeight;
  if (footerTop <= windowHeight) {
    const offset = windowHeight - footerTop + 10;
...
document.querySelectorAll('.options__input[type="radio"]').forEach((radio) => {
...
function formInit() {
  ...
  document.addEventListener("submit", function(e) {
    const form = e.target.closest("form[data-fls-form]");
    if (!form) return;
    const radioBlock = form.querySelector("[data-fls-radio]");
    if (radioBlock) {
      const radios = radioBlock.querySelectorAll(
        "input[type='radio'], input[type='checkbox']"
      );
      const oneChecked = Array.from(radios).some((r) => r.checked);
      if (!oneChecked) {
        e.preventDefault();
        radioBlock.classList.add("--form-error");
        const errText = document.createElement("div");
        errText.className = "form__error";
        errText.textContent = "Потрібно погодитися на обробку персональних даних";
        if (!radioBlock.querySelector(".form__error")) {
          radioBlock.appendChild(errText);
        }
        if (form.hasAttribute("data-fls-form-gotoerr")) {
          gotoBlock(radioBlock);
        }
      } else {
        radioBlock.classList.remove("--form-error");
        const err = radioBlock.querySelector(".form__error");
        if (err) err.remove();
      }
    }
  });
