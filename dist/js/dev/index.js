...
const marquee = () => {
  ...
  $marqueeArray.forEach(($wrapper) => {
    ...
    const initEvents = () => {
      ...
      $wrapper.removeEventListener("mouseenter", onChangePaused);
      $wrapper.removeEventListener("mouseleave", onChangePaused);
      $wrapper.addEventListener("mouseenter", onChangePaused);
      $wrapper.addEventListener("mouseleave", onChangePaused);
    };
    ...
    const onChangePaused = (e) => {
      const { type } = e;
      $marqueeInner.style.animationPlayState = type === "mouseenter" ? "paused" : "running";
    };
